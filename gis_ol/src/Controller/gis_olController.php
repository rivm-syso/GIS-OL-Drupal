...
class gis_olController extends ControllerBase {
	...
	public function content() {
		if (isset($_GET['help'])) {
			$r='<h2>Help</h2>';
			$r.='Deze help bevat de volgende onderwerpen:<ol><li><a href="#form">Formaat en uiterlijk</a></li><li><a href="#basis">Basiskaarten</a></li><li><a href="#knop">Knoppen en overige controls</a></li><li><a href="#layer">Layer definities</a></li><li><a href="#data">Data weergave</a></li></ol>';
			$r.='<h3><a name="form">Formaat en uiterlijk</a></h3>';
			$r.='<p><table>';
			$r.='<tr><td>Breedte:</td><td>De (maximale) breedte van de kaart.</td></tr>';
			$r.='<tr><td>Aspect ratio:</td><td>De hoogte van de kaart wordt berekend a.d.h.v. de breedte en de aspect-ration. Default is dit 1.2.DIT MOET NOG WORDEN AANGEPAST</td></tr>';
			$r.='<tr><td>CSS type:</td><td>DIT MOET NOG WORDEN AANGEPAST</td></tr>';
			$r.='<tr><td>Floating:</td><td>DIT MOET NOG WORDEN AANGEPAST</td></tr>';
			$r.='</table></p>';
			...
			$r.='<tr><td>Opacity:</td><td>Init&euml;le doorzichtigheid van de layer. Als bij de layers-knop de optie \'Met opacity slider\' is gekozen, dan kan de bezoeker deze init&iuml;ele doorzichtigheid aanpassen.</td></tr>';
